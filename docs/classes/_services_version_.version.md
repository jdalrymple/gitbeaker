...
\+ **new Version**(`__namedParameters`: object): *[Version](_services_version_.version.md)*
...
**Returns:** *[Version](_services_version_.version.md)*
...
▸ **show**(`options?`: [Sudo](../interfaces/_infrastructure_index_.sudo.md)): *Promise‹object | object | object[]›*

*Defined in [services/Version.ts:4](https://github.com/arsdehnel/node-gitlab/blob/c2ee9bb/src/services/Version.ts#L4)*
