...
\+ **new Lint**(`__namedParameters`: object): *[Lint](_services_lint_.lint.md)*
...
**Returns:** *[Lint](_services_lint_.lint.md)*
...
▸ **lint**(`content`: string, `options?`: [Sudo](../interfaces/_infrastructure_index_.sudo.md)): *Promise‹object›*

*Defined in [services/Lint.ts:4](https://github.com/arsdehnel/node-gitlab/blob/c2ee9bb/src/services/Lint.ts#L4)*
