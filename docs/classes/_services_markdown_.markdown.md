...
\+ **new Markdown**(`__namedParameters`: object): *[Markdown](_services_markdown_.markdown.md)*
...
**Returns:** *[Markdown](_services_markdown_.markdown.md)*
...
▸ **render**(`text`: string, `options`: object & [Sudo](../interfaces/_infrastructure_index_.sudo.md)): *Promise‹object›*

*Defined in [services/Markdown.ts:5](https://github.com/arsdehnel/node-gitlab/blob/c2ee9bb/src/services/Markdown.ts#L5)*
