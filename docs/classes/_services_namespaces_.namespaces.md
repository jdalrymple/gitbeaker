...
\+ **new Namespaces**(`__namedParameters`: object): *[Namespaces](_services_namespaces_.namespaces.md)*
...
**Returns:** *[Namespaces](_services_namespaces_.namespaces.md)*
...
*Defined in [services/Namespaces.ts:5](https://github.com/arsdehnel/node-gitlab/blob/c2ee9bb/src/services/Namespaces.ts#L5)*
...
▸ **show**(`namespaceId`: [NamespaceId](../modules/_services_index_.md#namespaceid), `options`: object & [Sudo](../interfaces/_infrastructure_index_.sudo.md)): *Promise‹object | object | object[]›*

*Defined in [services/Namespaces.ts:9](https://github.com/arsdehnel/node-gitlab/blob/c2ee9bb/src/services/Namespaces.ts#L9)*
