...
\+ **new Keys**(`__namedParameters`: object): *[Keys](_services_keys_.keys.md)*
...
**Returns:** *[Keys](_services_keys_.keys.md)*
...
▸ **show**(`keyId`: [KeyId](../modules/_services_index_.md#keyid), `options?`: [Sudo](../interfaces/_infrastructure_index_.sudo.md)): *Promise‹object | object | object[]›*

*Defined in [services/Keys.ts:5](https://github.com/arsdehnel/node-gitlab/blob/c2ee9bb/src/services/Keys.ts#L5)*
